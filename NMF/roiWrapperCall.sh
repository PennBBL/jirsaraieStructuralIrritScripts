###################################################################################################
##########################     GRMPY - Run ROI Wrapper on NMF Output     ##########################
##########################               Robert Jirsaraie                ##########################
...
subjDataName="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMF/n118_Demo+ARI+QA_20171108.rds"

OutDirRoot="/data/joy/BBL/projects/jirsaraieStructuralIrrit/output/NMF"  
...
input="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMF/n115_Nmf18Bases_CT_bblids.csv"

########################################################################
##### Calls the " gamROI.R" Rscript that will Perform the Analysis #####
########################################################################

Rscript /data/joy/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/NMF/gamROI.R  -c $subjDataName -o $OutDirRoot -p ${input} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5
