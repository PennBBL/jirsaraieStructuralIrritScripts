...
NMF_CT <- read.csv("/cbica/projects/pncNmf/grmpyNMF/n115_structCT/results/NumBases18/OPNMF/NmfResults18Bases_CT.csv", header=TRUE, na.strings=".")
...
write.csv(CT_Data, file = "/cbica/projects/pncNmf/grmpyNMF/n115_structCT/results/NumBases18/OPNMF/n115_Nmf18Bases_CT_bblids.csv",row.names=FALSE)
