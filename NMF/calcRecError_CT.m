% read the data
mask_nii = load_untouch_nii('/cbica/projects/pncNmf/grmpyNMF/n115_structCT/ctMask/n115_ctMask_thr9_2mm.nii.gz');
mask = mask_nii.img ;

data_lst = '/cbica/projects/pncNmf/grmpyNMF/n115_structCT/subjectdata/n115_ctSmoothPath.csv';
...
resultsPath='/cbica/projects/pncNmf/grmpyNMF/n115_structCT/results/';
numBases=2:2:30;
...
% make figure
    ...
    set(gca,'fontsize',12)
    saveas(fig,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/figures/reconstructionError_CT.png');
    ...
    saveas(fig2,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/figures/reconstructionErrorGradient_CT.png');
    ...
    set(gca,'fontsize',12)
    saveas(fig3,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/figures/percentageImprovementRecError_CT.png');
