...
subjDataName <- "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n137_Delta_NMF/n137_Demo+ARI+QA+TP1CT_COMBAT_20180401.rds"
OutDirRoot <- "/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/n137_Delta_NMF"
inputPath <- "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n137_Delta_NMF/n137_Nmf24BasesCT_COMBAT_Delta.csv"
inclusionName <- "DeltaEXCLUDE"
subjID <- "bblid,scanid"
covsFormula <- "~DeltaAge+TP1ageAtScan1+ari_total+DeltaManualRating+sex"
pAdjustMethod <- "fdr"
ncores <- 5
residualMap <- FALSE
