...
#$ -o /cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/logs/extractBasesMT.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/logs/extractBasesMT.$JOB_ID.stderr
####
#### My email address:
#$ -M rjirsaraie@ymail.com
...
/bin/echo "Command: /cbica/projects/pncNmf/grmpyNMF/n229_longitudinal/scripts/extractBasesMT"
...
/bin/echo "Command: /cbica/projects/pncNmf/grmpyNMF/n229_longitudinal/scripts/extractBasesMT" 1>&2
/bin/echo "Arguments: List of input files: $1 NumBases: $2 Output Directory: $3 mask: $4"
...
extractBasesMT=/cbica/projects/pncNmf/grmpyNMF/n229_longitudinal/scripts/extractBasesMT
...
if [ $? != 0 ] ; then
	...
	echo "${date_info} : Failure to execute extractBasesMT, JobID: ${JOB_ID}, method: ${method}, number of bases: ${num_bases}" >> /cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/logs/FailedExtractBasesExperimentsMT.txt
	exit 1
fi
