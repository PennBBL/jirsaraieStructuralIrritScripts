...
fig = figure;plot(sortedBasisNum,cell2mat(meanInner),'b','LineWidth',2)
xlabel('Number of components','fontsize',12)
ylabel({'Split-sample reproducibility';'(mean inner product)'},'fontsize',12)
set(gca,'fontsize',12)
saveas(fig,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/MeanInnerProduct_CT.png');

fig2 = figure;plot(sortedBasisNum,cell2mat(medianInner),'b','LineWidth',2)
xlabel('Number of components','fontsize',12)
ylabel({'Split-sample reproducibility';'(median inner product)'},'fontsize',12)
set(gca,'fontsize',12)
saveas(fig2,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/MedianInnerProduct_CT.png');

fig3 = figure;plot(sortedBasisNum,ARI,'b','LineWidth',2)
xlabel('Number of components','fontsize',12)
ylabel({'Split-sample reproducibility' ;'(Adjusted Rand Index)'},'fontsize',12)
set(gca,'fontsize',12)
saveas(fig3,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/AdjustedRandIndex_CT.png');
