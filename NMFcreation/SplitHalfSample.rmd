...
subjData <- readRDS("/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n288_Repeat_JLF/n288_Demo+ARI+QA_20180305.rds")
subjData <- subjData[ which(subjData$T1exclude=='1'),] 
dataToSplit <- subjData[,c('bblid','scanid','ageatscan','sex','race','rating','T1exclude','TP2_ZariTotal','TP2_ZariLog','Zari_total')]
...
write.csv(dataTrain,'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMFcreation/n141_T1_train.csv',row.names=FALSE, quote=FALSE)
write.csv(dataTest,'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMFcreation/n140_T1_test.csv',row.names=FALSE, quote=FALSE)
...
#Save lists.
write.csv(bblidsScanids_train, file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMFcreation/n141_T1_train_bblids_scanids.csv", row.names=FALSE)
write.csv(bblidsScanids_test, file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMFcreation/n140_T1_test_bblids_scanids.csv", row.names=FALSE)
