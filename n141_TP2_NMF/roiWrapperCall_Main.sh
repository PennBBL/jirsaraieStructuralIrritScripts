...
subjDataName="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n141_TP2_NMF/n141_Demo+ARI+QA_20180322.rds"
...
covsFormula="~s(ageatscan,k=4)+ari_log+sex+rating+medications"
