...
subjDataName="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n141_TP2_NMF/n141_AllDimensions_20180602.rds"
...
covsFormula="~s(ageatscan,k=4)+ari_log+sex+rating+log_BDI_DEPRESSIONdim+log_SCARED_ANXITYdim+log_SWAN_ADHDdim"
