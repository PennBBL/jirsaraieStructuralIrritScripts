...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/creationFigures/TP2_COMBAT_NMF/ScatterPlot_ctTP2_Network18.png")
...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/creationFigures/TP2_COMBAT_NMF/ScatterPlot_ctTP2_Network1.png")
