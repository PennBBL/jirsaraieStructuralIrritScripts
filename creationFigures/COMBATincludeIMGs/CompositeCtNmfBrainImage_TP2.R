...
antsImageWrite(newImg,"/home/rjirsaraie/NMFfigures/CtNmf24Components.nii.gz")
...
antsImageWrite(tvalMap,"/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/creationFigures/TP2_COMBAT_NMF/n141_CtNmfSigComponents_COMBAT_t400_TP2.nii.gz")
