...
subjDataName="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Rate_JLF/n141_Demo+STAXI+QA_20180322.rds"
...
covsFormula="~TP1ageAtScan1+traitanger_log+DeltaManualRating+sex"
...
input="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Rate_JLF/n141_jlfAntsCTIntersectionCTannualRate_20180404.csv"
...
Rscript /data/jux/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/n144_Rate_JLF/gamROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5 
