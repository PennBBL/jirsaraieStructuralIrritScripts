...
subjDataName="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMFcross-sectional/n118_Demo+ARI+QA_20171103.rds"

OutDirRoot="/data/joy/BBL/projects/jirsaraieStructuralIrrit/output/NMFcross-sectional/"  
...
input=/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMFcross-sectional/n115_Nmf18Bases_CT_bblids.csv
...
Rscript /data/joy/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/NMFcross-sectional/analysis/gamROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5
