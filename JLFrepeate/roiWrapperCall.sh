...
subjDataName="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/JLFrepeate/n236_Demo+ARI+QA_20171117.rds"

OutDirRoot="/data/joy/BBL/projects/jirsaraieStructuralIrrit/output/JLFrepeate"  
...
path="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/JLFrepeate"
...
Rscript /data/joy/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/JLFrepeate/gamm4ROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5 -e $randomFormula
