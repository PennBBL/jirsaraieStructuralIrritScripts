...
CallScript=/data/jux/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/creationNMF/Run_NMF_CT.sh
RunScript=/data/jux/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/creationNMF/submit_script_extractBasesMT.sh
