...
write.csv(dataTrain,'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationNMF/n141_T1_train.csv',row.names=FALSE, quote=FALSE)
write.csv(dataTest,'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationNMF/n140_T1_test.csv',row.names=FALSE, quote=FALSE)
...
#Save lists.
write.csv(bblidsScanids_train, file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationNMF/n141_T1_train_bblids_scanids.csv", row.names=FALSE)
write.csv(bblidsScanids_test, file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationNMF/n140_T1_test_bblids_scanids.csv", row.names=FALSE)
