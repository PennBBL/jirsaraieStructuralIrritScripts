...
subjDataName="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMFlongitudinal/n229_Demo+ARI+QA_20171125.rds"

OutDirRoot="/data/joy/BBL/projects/jirsaraieStructuralIrrit/output/NMFlongitudinal"  
...
input="/data/joy/BBL/projects/jirsaraieStructuralIrrit/data/NMFlongitudinal/n229_Nmf18Bases_CT_bblids.csv"
...
Rscript /data/joy/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/NMFlongitudinal/analysis/gamm4ROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5 -e $randomFormula
