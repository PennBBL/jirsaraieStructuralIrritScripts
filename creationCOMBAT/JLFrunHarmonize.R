...
##### Subjects Below were Excluded For Missing Data or Manual QA #####

# BBLID, SCANIDtp1,SCANIDtp2
# 105176,10571,5077,
# 126554,10580,10577         
# 85083,5464,3224
...
TP1<-TP1[,c(2,1,3:100)]
write.csv(TP1, "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationCOMBAT/n141_jlfAntsCTcombatTP1_20180429.csv")
...
TP2<-TP2[,c(2,1,3:100)]
write.csv(TP2, "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationCOMBAT/n141_jlfAntsCTcombatTP2_20180429.csv")

###Write for Whole Sample###

Combined<-rbind(TP1,TP2)
write.csv(output, "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/creationCOMBAT/n282_jlfAntsCTcombat_20180429.csv")
