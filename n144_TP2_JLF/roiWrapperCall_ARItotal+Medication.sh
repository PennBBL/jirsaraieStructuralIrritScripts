...
subjDataName="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_TP2_JLF/n144_Demo+ARI+QA_20180322.rds"

OutDirRoot="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/n144_TP2_JLF"  
...
covsFormula="~s(ageatscan,k=4)+ari_total+rating+sex+medications_yesno"
...
path="/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_TP2_JLF"

input="${path}/n144_jlfAntsCTIntersectionVol_20180320.csv ${path}/n144_jlfAtroposIntersectionGMD_20180320.csv ${path}/n144_jlfAntsCTIntersectionCT_20180320.csv"
...
Rscript /data/jux/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritScripts/n144_TP2_JLF/gamROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5
