% read the data
mask_nii = load_untouch_nii('/cbica/projects/pncNmf/grmpyNMF/n115_structCT/ctMasks/n115_ctMask_thr9_2mm.nii.gz');
mask = mask_nii.img ;
...
% make figure
    ...
    set(gca,'fontsize',12)
    saveas(fig,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/graphs/reconstructionError_CT.png');
    ...
    saveas(fig2,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/graphs/reconstructionErrorGradient_CT.png');
    ...
    set(gca,'fontsize',12)
    saveas(fig3,'/cbica/projects/pncNmf/grmpyNMF/n115_structCT/graphs/percentageImprovementRecError_CT.png');
