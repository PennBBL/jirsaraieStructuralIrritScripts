...
subjDataName <- "/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Delta_JLF/n144_Demo+ARI+QA+tp1CT_20180411.rds"
...
subjID <- "bblid,scanid"
covsFormula <- "~DeltaAge+ari_log+AvgManRating+sex+TP1ageAtScan1"
pAdjustMethod <- "fdr"
ncores <- 5
residualMap <- FALSE
