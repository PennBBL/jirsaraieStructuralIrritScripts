...
write.csv(diffVOL, paste('/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Delta_JLF/n144_jlfAntsCTIntersectionVOLdiff_',format(Sys.Date(), format="%Y%m%d"),'.csv', sep=''), quote=F, row.names=F)

write.csv(diffCT, paste('/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Delta_JLF/n144_jlfAntsCTIntersectionCTdiff_',format(Sys.Date(), format="%Y%m%d"),'.csv', sep=''), quote=F, row.names=F)

write.csv(diffGMD, paste('/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n144_Delta_JLF/n144_jlfAtroposIntersectionGMDdiff_',format(Sys.Date(), format="%Y%m%d"),'.csv', sep=''), quote=F, row.names=F)
