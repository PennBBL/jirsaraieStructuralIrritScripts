...
output<-read.csv("/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/n141_TP2_NMF/n141_rds_n141_Demo+ARI+QA_20180322_inclusion_T1exclude_ROI_n141_Nmf24BasesCT_TP2/gam_formula_sageatscank4_ari_log_rating_sex_coefficients.csv")
...
tvalVoxVector[which(tvalVoxVector==13)] <- -4.80
tvalVoxVector[which(tvalVoxVector==15)] <- -4.10
tvalVoxVector[which(tvalVoxVector==1)] <- -3.64
tvalVoxVector[which(tvalVoxVector==18)] <- -3.43
tvalVoxVector[which(tvalVoxVector==11)] <- -3.31
tvalVoxVector[which(tvalVoxVector==8)] <- -3.06
tvalVoxVector[which(tvalVoxVector==22)] <- -2.93
tvalVoxVector[which(tvalVoxVector==10)] <- -2.70
tvalVoxVector[which(tvalVoxVector==21)] <- -2.61
tvalVoxVector[which(tvalVoxVector==9)] <- -2.63
tvalVoxVector[which(tvalVoxVector==20)] <- -2.30
...
antsImageWrite(tvalMap,"/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/NMFcreation/finalFigures/n141_CtNmfSigComponents_t300_TP2.nii.gz")
