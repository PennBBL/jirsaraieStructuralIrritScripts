...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/NMFfigures/Rate_COMBAT_NMF/ScatterPlot_ctRATE_Network18.png")
...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/NMFfigures/Rate_COMBAT_NMF/ScatterPlot_ctRATE_Network1.png")
