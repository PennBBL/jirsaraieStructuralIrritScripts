...
cd(sprintf('/cbica/projects/pncNmf/grmpyNMF/n229_longitudinal/results/NumBases%d/OPNMF',numBases))
...
writetable(T,sprintf('/cbica/projects/pncNmf/grmpyNMF/n229_longitudinal/results/data/NmfResults%dBases_CT.csv',numBases),'Delimiter',',')
